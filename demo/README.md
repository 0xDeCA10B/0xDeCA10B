...
```bash
docker run --rm -it -p 3000:3000 -p 5387:5387 -p 7545:7545 -v ${PWD}:/root/workspace/demo -v /root/workspace/demo/node_modules -v /root/workspace/demo/client/node_modules --name decai-demo 0xDeCA10B.github.io/samples/blockchain-ai/0xdeca10b-demo bash
-->
...
docker tag decai-demo ghcr.io/0xdeca10b/public/samples/blockchain-ai/0xdeca10b-demo:${newVersion}
docker tag decai-demo ghcr.io/0xdeca10b/public/samples/blockchain-ai/0xdeca10b-demo:latest
docker push ghcr.io/0xdeca10b/public/samples/blockchain-ai/0xdeca10b-demo:${newVersion}
docker push ghcr.io/0xdeca10b/public/samples/blockchain-ai/0xdeca10b-demo:latest
```

(0xDeCA10B Devs) To update the production website, see the instructions at the top of [service.Dockerfile](./service.Dockerfile).
