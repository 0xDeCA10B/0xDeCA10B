...
class About extends React.Component {
  ...
  render() {
  	...
  	return (<Container maxWidth="lg">
        ...
        ⚠ WARNING When you upload a model or data to train a model, that data is most likely added to a version of a third party <Link href='https://ethereum.org/' target='_blank'>Ethereum</Link> blockchain network not controlled by 0xDeCA10B.
        Unless explicitly indicated, your data is not stored on 0xDeCA10B controlled machines.
        ...
        0xDeCA10B has no control over these transactions since the request is never sent to 0xDeCA10B machines before being sent from your browser directly to the blockchain network.
  		</Typography>
  		<Typography className={classes.section} component="p">
        ...
        0xDeCA10B does not fully endorse nor support the use of the mainnet or any other third party network because all information in it is public and might be difficult to completely delete.
  		</Typography>
  		<Typography className={classes.sectionTitle} variant="h5" component="h5">
        ...
        An overview of the project can be found in our <Link href='https://aka.ms/0xDeCA10B-blog1' target="_blank">blog post</Link>.
  		...
  		<Typography className={classes.section} component="p">
        The <Link href='https://go.0xDeCA10B.github.io/fwlink/?LinkID=246338' target='_blank'>Code of Conduct</Link> for 0xDeCA10B should be followed.
  		</Typography>
  		<Typography className={classes.section} component="p">
