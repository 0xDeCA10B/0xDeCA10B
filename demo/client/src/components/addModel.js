  ...
  render() {
  	...
  	return (
  		<Container>
            ...
            If the transactions are approved, you might be sending data to a public dencentralized blockchain not controlled by 0xDeCA10B.
            Before approving, you should understand the implications of interacting with a public blockchain.
              ...
              >
                ...
                The syntax for the file can be found <Link href='https://github.com/0xDeCA10B/0xDeCA10B/wiki/Models#model-files' target='_blank'>here</Link>.
  						</Typography>
